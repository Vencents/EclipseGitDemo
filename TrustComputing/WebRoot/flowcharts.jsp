...
<body>
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>所有用户</h2>
						<div class="box-icon">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>实时流量</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
					...
					<div class="box-content">
						<div id="container" style="width:1120px; height: 450px; margin: 0 auto;"></div>
					</div>
				</div><!--/span-->
			</div><!--/row-->
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>柱状图排名</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
					...
					<div class="box-content">
						<div id="column_container" style="height: 415px; width: 1120px；margin: 0 auto"></div>
					</div>
				</div><!--/span-->
			</div><!--/row-->
	...
	<script type="text/javascript" src="highcharts/gray.js"></script>
	<script type="text/javascript" src="customJs/flowcharts.js"></script>
	<script type="text/javascript" src="customJs/column.js"></script>
	<!-- jqeury grid library -->
