...
<body>
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>系统用户列表</h2>
						<div class="box-icon">
			...
			<div class="row-fluid sortable">
				<div class="box span6">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>添加用户</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
						...
						<form class="form-horizontal" id="addUser">
							<fieldset>
							  ...
							  <div class="control-group success">
								...
								<div class="controls">
								  <input type="text" id="inputpasswd">
								</div>
							  </div>
							  ...
							  <div class="control-group success">
								<label class="control-label" for="inputstate">信任状态</label>
								<div class="controls">
								  	 <select id="inputstate">
										<option value='trusted'>平台可信任</option>
										<option value='untrusted'>平台不可信任</option>
									  </select>
								</div>
							  </div>
							  
							  <div class="control-group success">
								<label class="control-label" for="inputlevel">信任等级</label>
								<div class="controls">
								  	 <select id="inputlevel">
										<option value='0'>安全</option>
										<option value='1'>可疑</option>
										<option value='2'>威胁</option>
							  ...
							  <div class="form-actions">
								...
								<button class="btn btn-warning" id="cancel_submit">重置所有</button>
							  </div>	
						</fieldset>
						</form>
					</div>
				...
				<div class="box span6">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>用户违规记录</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>用户操作日志</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
	...
	<!-- 页面Ajax调用 -->
	<script type="text/javascript" src="customJs/usertables.js"></script>
