	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"> <img alt="Charisma Logo" src="img/logo20.png" /> <span class="span4">State Grid System</span></a>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
				  <div class="box-header well" data-original-title>
					  <h2><i class="icon-calendar"></i>行程安排</h2>
					  <div class="box-icon">
				  ...
				  <div class="box-content">
					<div id="external-events" class="well">
						<h4>拖拽事件</h4>
						<div class="external-event badge">默认</div>
						<div class="external-event badge badge-success">完成</div>
						<div class="external-event badge badge-warning">警告</div>
						<div class="external-event badge badge-important">重要</div>
						<div class="external-event badge badge-info">提醒</div>
						<div class="external-event badge badge-inverse">其他</div>
						<p>
						<label for="drop-remove"><input type="checkbox" id="drop-remove" /> 拖拽之后移除</label>
						</p>
						</div>
